...
<?php endif; ?>
	...
	<?php edit_post_link( esc_html__( 'Edit', 'bigshopper' ), '<span class="edit-link"><i class="fa fa-pencil"></i>', '</span>' ); ?>
      ...
      <!-- .entry-header -->
        <div class="entry-attachment">
          ...
          <?php
				the_content();
				wp_link_pages( array(
					'before'      => '<div class="page-links"><span class="page-links-title">' . esc_html__( 'Pages:', 'bigshopper' ) . '</span>',
					'after'       => '</div>',
					'link_before' => '<span>',
					'link_after'  => '</span>',
				) );
      ...
      <nav id="image-navigation" class="navigation image-navigation">
        <div class="nav-links">
          <?php previous_image_link( false, '<div class="previous-image">' . esc_html__( 'Previous Image', 'bigshopper' ) . '</div>' ); ?>
          <?php next_image_link( false, '<div class="next-image">' . esc_html__( 'Next Image', 'bigshopper' ) . '</div>' ); ?>
        </div><!-- .nav-links -->
      </nav>
      <!-- #image-navigation -->
