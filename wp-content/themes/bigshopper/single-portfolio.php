...
<?php endif; ?>
  ...
  <div id="content" class="site-content" role="main">
	...
	<?php edit_post_link( esc_html__( 'Edit', 'bigshopper' ), '<span class="edit-link"><i class="fa fa-pencil"></i>', '</span>' ); ?>
		...
		<?php the_content(); ?>
        <?php wp_link_pages( array( 'before' => '<div class="page-link">' . esc_html__( 'Pages:', 'bigshopper' ), 'after' => '</div>' ) ); ?>
      </div>
      <!-- .entry-content -->
      <div class="entry-utility-port">
        <?php edit_post_link( esc_html__( 'Edit', 'bigshopper' ), '<span class="edit-link">', '</span>' ); ?>
      </div>
      <!-- .entry-utility -->
